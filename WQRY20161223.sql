...
BEGIN
	...
	RAISE NOTICE 'v_fecha_inicio ( % ) v_fecha_fin ( % )',v_fecha_inicio,v_fecha_fin;

	RETURN QUERY
	SELECT
		age.id,age.inicio_planificado,age.fin_planificado,age.persona_id,
		vp.nombre_completo::VARCHAR,age.intervalo_id,intv.nombre,
		CASE
